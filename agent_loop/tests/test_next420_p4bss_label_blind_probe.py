...
import experiments.next420_p4bss_label_blind_probe as p
...
def test_hashes_cover_frozen_execution_surface_and_obs_control() -> None:
    ...
    assert tuple(hashes)[-2:] == (
        "tests/test_next420_pauling4_bond_strength_segregation.py",
        "tests/test_next420_p4bss_label_blind_probe.py",
    )
