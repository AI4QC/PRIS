...
import src.next274_joint_radical_broad_diagnostic as n
...
def test_diagnostic_interface_excludes_validation_and_replication() -> None:
    parameters = tuple(inspect.signature(n.run_joint_radical_broad_diagnostic).parameters)
...
def test_diagnostic_fails_closed_on_missing_input(tmp_path) -> None:
    with pytest.raises(FileNotFoundError, match="NEXT274 input is missing"):
        n.run_joint_radical_broad_diagnostic(
            ...
            design_path=tmp_path / "design273",
