...
import experiments.next455_pfpu_label_blind_probe as p
...
def test_hashes_cover_pcabsm_and_pfpu_surface() -> None:
    ...
    assert tuple(hashes)[-2:] == (
        "tests/test_next455_path_field_participation_uniformity.py",
        "tests/test_next455_pfpu_label_blind_probe.py",
    )
