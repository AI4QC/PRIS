...
import experiments.next440_pcabp_label_blind_probe as p
...
def test_hashes_cover_pvtm_and_pcabp_surface() -> None:
    ...
    assert tuple(hashes)[-2:] == (
        "tests/test_next440_path_constrained_apriori_bond_positivity.py",
        "tests/test_next440_pcabp_label_blind_probe.py",
    )
