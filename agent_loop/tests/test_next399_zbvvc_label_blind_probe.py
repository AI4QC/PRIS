...
import experiments.next399_zbvvc_label_blind_probe as p
...
def test_hashes_cover_the_frozen_execution_surface() -> None:
    ...
    assert tuple(hashes)[-2:] == (
        "tests/test_next399_zachara_bond_valence_vector_closure.py",
        "tests/test_next399_zbvvc_label_blind_probe.py",
    )
