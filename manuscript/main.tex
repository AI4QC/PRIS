...
\usepackage{url}%
\usepackage{siunitx}%
\usepackage{bookmark}%  after the class's hyperref: lets the back matter sit at the root of the outline
...
%% begin{document} so that cross-references and citations are visibly clickable
...
\input{si-xr}% SI cross-refs, generated from si.aux by gen-si-xr.py
...
Z.S. and L.C. conceived the study. Z.S. built the agent workflow, analysed the results,
performed the density functional theory calculations and wrote the manuscript. L.C.
